package com.texdevs.agendafinanciera.data
...
import com.texdevs.agendafinanciera.CurseFirebaseApp.Companion.context
...
class Repository {
    ...
    suspend fun getMinAllowedVersion(): List<Int> {
        ...
        return if (minVersion.isBlank()) listOf(0, 0, 0) else
